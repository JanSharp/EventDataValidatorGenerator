...
local check_string_helpers = {
  ...
  ["final-health"] = function(filter)
    return "final-health" .. filter.value .. filter.comparison
  end,
}
...
local check_table_helpers = {
  ...
  ["ghost_type"] = function(filter)
    ...
    return {
      local_name = "ghost_type",
      value = filter.ghost_type,
      invert = filter.invert,
      mode = filter.mode or "or",
    }
  end,
  ...
  ["ghost_name"] = function(filter)
    ...
    return {
      local_name = "ghost_name",
      value = filter.ghost_name,
      invert = filter.invert,
      mode = filter.mode or "or",
    }
  end,
  ...
  ["original-damage-amount"] = function(filter)
    ...
    return {
      local_name = "original_damage_amount",
      value = filter.value,
      comparator = comparator_map[filter.comparison],
      invert = filter.invert,
      mode = filter.mode or "or",
    }
  end,
  ...
  ["final-damage-amount"] = function(filter)
    needed_localed_fields["final_damage_amount"] = "event.final_damage_amount"
    return {
      local_name = "final_damage_amount",
      value = filter.value,
      comparator = comparator_map[filter.comparison],
      invert = filter.invert,
      mode = filter.mode or "or",
  ...
  ["final-health"] = function(filter)
    needed_localed_fields["final_health"] = "event.final_health"
    return {
      local_name = "final_health",
      value = filter.value,
      comparator = comparator_map[filter.comparison],
      invert = filter.invert,
      mode = filter.mode or "or",
